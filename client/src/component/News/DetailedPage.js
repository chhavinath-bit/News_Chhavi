...
export default function DetailedPage() {
  ...
  return (
    <div className='h-11/12 w-full flex justify-center overflow-y-auto box-border py-4'>
    <div className='w-[70%] flex flex-col bg-[#F1F1F1] flex-shrink-0 py-3 px-5 rounded-lg'>
      <div className='w-full h-[9vh] flex box-border my-1 flex-shrink-0'>
      ...
      <div className='w-full h-px bg-black mb-3 flex-shrink-0'></div>
      <div className='mb-3 flex-shrink-0'>
        <h1 className='text-4xl font-bold'>{data.heading}</h1>
      </div>
      <div className='w-full flex-shrink-0'>
        <img src={data.news_Image.length?data.news_Image[0]: newsImageAlt} className={`${styleArr[ind]} m-2 w-[480px] `} alt=''></img>
        <p>{data.Content}</p>
      </div>
